	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001ea:	0f be 80 a8 0e 80 00 	movsbl 0x800ea8(%eax),%eax
  8001f1:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80037e:	50                   	push   %eax
  80037f:	68 c0 0e 80 00       	push   $0x800ec0
  800384:	53                   	push   %ebx
  800385:	56                   	push   %esi
  ...
  800399:	52                   	push   %edx
  80039a:	68 c9 0e 80 00       	push   $0x800ec9
  80039f:	53                   	push   %ebx
  8003a0:	56                   	push   %esi
  ...
  8003c4:	b8 b9 0e 80 00       	mov    $0x800eb9,%eax
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800bba:	e8 2c f5 ff ff       	call   8000eb <vcprintf>
	cprintf("\n");
  800bbf:	c7 04 24 9c 0e 80 00 	movl   $0x800e9c,(%esp)
